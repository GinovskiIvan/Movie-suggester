...
foreach($votes as $vote){
    $id=$vote['votes']['movie_id'];
        $movies=file_get_contents("http://api.themoviedb.org/3/movie/".$id."?api_key=cbb012e4e7ece74ac4c32a77b00a43eb");
    $movie=json_decode($movies,true);
    $movie['votes']=$vote['0']['count(user_id)'];
